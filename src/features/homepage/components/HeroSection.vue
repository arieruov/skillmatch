	...
	<section class="bg-gray-100 px-8 py-20">
		<div className="max-w-7xl mx-auto text-center">
			<h2 className="text-6xl font-bold text-slate-900 mb-6">
				...
				<span className="text-violet-600 block">basado en tus habilidades</span>
			</h2>
			<p className="text-xl text-slate-600 mb-8 max-w-3xl mx-auto">
				SkillMatch conecta tu talento con las oportunidades ideales. Filtra ofertas de
				trabajo que realmente coincidan con tus habilidades y experiencia.
			</p>
			...
			<!-- Popular Skills -->
			<div class="mb-12">
				<p class="mb-4 text-sm font-medium text-slate-600">Habilidades populares:</p>
				<div class="flex flex-wrap justify-center gap-2">
					<span
						v-for="skill in skills"
						:key="skill"
						class="cursor-pointer rounded-lg bg-violet-50 px-4 py-1.5 text-sm font-medium text-violet-700 shadow-sm transition hover:bg-violet-200 hover:text-violet-900"
					>
						{{ skill }}
					</span>
				</div>
